...
import { ApprovalHRIRDetailRoutingModule } from './approval-hrir-detail-routing.module'
...
@NgModule({
  declarations: [ApprovalHRIRDetailComponent],
  imports: [
    ...
    ButtonDirective,
    HttpClientModule,
    ApprovalHRIRDetailRoutingModule,
    ButtonGroupComponent,
    RouterLink,
    CardHeaderComponent,
    CardBodyComponent
...
export class ApprovalHRIRDetailModule { }
