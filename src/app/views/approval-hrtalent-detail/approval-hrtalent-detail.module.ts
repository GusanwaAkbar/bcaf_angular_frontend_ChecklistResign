...
import { ApprovalHRTalentDetailRoutingModule } from './approval-hrtalent-detail-routing.module'
...
@NgModule({
  declarations: [ApprovalHRTalentDetailComponent],
  imports: [
    ...
    ButtonDirective,
    HttpClientModule,
    ApprovalHRTalentDetailRoutingModule,
    ButtonGroupComponent,
    RouterLink,
    CardHeaderComponent,
    CardBodyComponent
...
export class ApprovalHRTalentDetailModule { }
