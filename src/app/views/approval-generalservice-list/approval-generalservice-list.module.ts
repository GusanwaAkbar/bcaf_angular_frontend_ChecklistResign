...
import { ApprovalGeneralServiceListRoutingModule } from './approval-generalservice-list-routing.module';
...
@NgModule({
  declarations: [ApprovalGeneralServiceListComponent],
  imports: [
    ...
    ButtonDirective,
    HttpClientModule,
    ApprovalGeneralServiceListRoutingModule,
    ButtonGroupComponent,
    RouterLink,
    CardHeaderComponent,
    CardBodyComponent
...
export class ApprovalGeneralServiceListModule { }
