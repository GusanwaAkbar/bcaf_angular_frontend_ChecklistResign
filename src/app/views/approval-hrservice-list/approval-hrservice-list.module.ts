...
import { ApprovalHRServiceListRoutingModule } from './approval-hrservice-list-routing.module';
...
@NgModule({
  declarations: [ApprovalHRServiceListComponent],
  imports: [
    ...
    ButtonDirective,
    HttpClientModule,
    ApprovalHRServiceListRoutingModule,
    ButtonGroupComponent,
    RouterLink,
    CardHeaderComponent,
    CardBodyComponent
...
export class ApprovalHRServiceListModule { }
