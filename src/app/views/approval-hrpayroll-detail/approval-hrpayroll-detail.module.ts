...
import { ApprovalHRPayrollDetailRoutingModule } from './approval-hrpayroll-detail-routing.module'
...
@NgModule({
  declarations: [ApprovalHRPayrollDetailComponent],
  imports: [
    ...
    ButtonDirective,
    HttpClientModule,
    ApprovalHRPayrollDetailRoutingModule,
    ButtonGroupComponent,
    RouterLink,
    CardHeaderComponent,
    CardBodyComponent
...
export class ApprovalHRPayrollDetailModule { }
