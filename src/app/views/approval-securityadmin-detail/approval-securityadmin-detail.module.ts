...
import { ApprovalSecurityAdminDetailRoutingModule } from './approval-securityadmin-detail-routing.module'
...
@NgModule({
  declarations: [ApprovalSecurityAdminDetailComponent],
  imports: [
    ...
    ButtonDirective,
    HttpClientModule,
    ApprovalSecurityAdminDetailRoutingModule,
    ButtonGroupComponent,
    RouterLink,
    CardHeaderComponent,
    CardBodyComponent
...
export class ApprovalSecurityAdminDetailModule { }
